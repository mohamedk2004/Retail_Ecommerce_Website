...
<div>
  ...
  <table class="table ">
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" style="height:40px"  onclick="deleteRow(this)">Delete</button></td>
      </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addVariationForm">
                            ...
                            <div class="form-group">
                                <button type="button" onclick="addVariation()" class="btn btn-secondary" style="height:40px">Add Variation</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editVariationForm">
                            ...
                            <div class="form-group">
                                <button type="button" onclick="saveChanges()" class="btn btn-secondary" style="height:40px">Save Changes</button>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
