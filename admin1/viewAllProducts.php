  ...
  <div>
    ...
    <table class="table">
      ...
      <tbody id="productTableBody">
        ...
        <tr>
      <td>1</td>
      <td><img height='100px' src='../assets/imgs/v-neck.jpg'></td>
      <td>V Neck Crop Top</td>
      <td>V neckline and Drawstring style make you more sexy Match well with your skinny leggings, pants or jeans for a fashion look Suitable for casual, home.</td>      
      <td>Tops</td> 
      <td>600</td>     
      ...
      <td>Crop Tops for Women Basic Off Shoulder Sexy Print V Neck Slim Shirt Vest with Button at Swiss Collecttion.</td>      
      <td>Tops</td> 
      <td>890</td>     
      <td><button class="btn btn-primary" style="height:40px" onclick="openEditModal(this)">Edit</button></td>
          <td><button class="btn btn-danger" style="height:40px" onclick="deleteProduct(this)">Delete</button></td>
