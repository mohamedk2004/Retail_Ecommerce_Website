...
<body>
        ...
        <div class="row" id="wishlist-items">
            ...
            <div class="col-md-4 wishlist-item" data-index="<?php echo $index; ?>">
                ...
                <button class="btn btn-primary" 
                    <?php if (!$item['in_stock']) echo 'disabled'; ?>
                    onclick="addToCart('<?php echo htmlspecialchars($item['title']); ?>', <?php echo $item['price']; ?>, '<?php echo htmlspecialchars($item['image']); ?>'); openCartSidebar();">
    ...
    <script src="path/to/navbar.js"></script> <!-- Include your navbar JavaScript here -->
    <script>
