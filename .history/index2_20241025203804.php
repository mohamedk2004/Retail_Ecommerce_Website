...
<head>
    ...
    <title>Home Page with Carousel and Promotions</title>
...
<body>
    ...
    <div class="container">
        ...
        <form class="d-flex me-3">
            ...
            <input class="form-control search-input rounded-pill" type="search" placeholder="Search" aria-label="Search">
    ...
    <div class="carousel-inner">
        ...
        <img src="https://via.placeholder.com/1920x500?text=First+Slide" class="d-block w-100" alt="First Slide">
        </div>
        <div class="carousel-item">
        <img src="https://via.placeholder.com/1920x500?text=Second+Slide" class="d-block w-100" alt="Second Slide">
        </div>
        <div class="carousel-item">
        <img src="https://via.placeholder.com/1920x500?text=Third+Slide" class="d-block w-100" alt="Third Slide">
        </div>
    </div>
