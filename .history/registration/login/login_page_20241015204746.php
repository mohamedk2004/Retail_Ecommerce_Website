...
<body class="d-flex flex-column min-vh-100">
    <!-- Top bar -->
    <div class="container-fluid registration-navbar text-center mb-5">
    ...
    <!-- Footer -->
    <footer class="registration-footer mt-auto py-3 bg-light">
        <div class="container text-center">
            <span class="text-muted">Copyright @ 2024 CompanyName</span>
        </div>
    </footer>
