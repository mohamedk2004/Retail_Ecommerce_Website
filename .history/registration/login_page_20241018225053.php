    ...
    <div class="container d-flex justify-content-center align-items-center flex-grow-1">
        <div class="card p-4 shadow-sm" style="max-width: 600px; width: 100%; min-height: 550px;">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" novalidate>
                ...
                <!-- Submit button -->
                <div class="d-grid gap-2 mt-4 submit-btn-div">
            ...
            <div class="text-center mt-4">
                <p>Don't have an account? <a href="sign_up_page.php" class="text-decoration-none link">Sign up</a></p>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success" name="forgot_password_submit">Update
                                Password</button>
                        </div>
                    </form>
                </div>
