...
class OrdersModel extends Model {
    ...
    function addProduct($productName, $productDescription, $productPrice, $stockQuantity, $productImage) {
        ...
        $sql = "INSERT INTO orders (order_date, total_amount, product_price, stock_quantity, product_image) 
                VALUES ('$order_date', '$total_amount', '$product_price', '$stock_quantity', '$product_image')";
