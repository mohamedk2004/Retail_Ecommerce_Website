...
function editOrder($orderStatus)
{
    ...
    $sql = "UPDATE products SET status='$productName', productDescription='$productDescription', productPrice='$productPrice', stockQuantity='$stockQuantity' WHERE productId=$this->productId;";
