...
class OrdersModel extends Model {
    ...
    function addProduct($productrName, $productDescription, $productPrice, $stockQuantity, $productImage) {
        // SQL query to insert a new product into the orders table
        $sql = "INSERT INTO orders (order_date, total_amount, order_status) 
                VALUES ('$order_date', '$total_amount', '$order_status')";
