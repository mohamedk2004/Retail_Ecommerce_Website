...
class OrderItemsModel extends Model {
    ...
    function addProduct($order_items, $order_date, $total_amount, $order_status) {
        // SQL query to insert a new product into the orderItems table
        $sql = "INSERT INTO orderItems (order_items, order_date, total_amount, order_status) 
                VALUES ('$order_items',$order_date', '$total_amount', '$order_status')";
