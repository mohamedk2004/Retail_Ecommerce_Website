...
class WishlistItemsModel extends Model {
    ...
    function addWishlistItem($wishlist_id, $product_id) {
        // SQL query to insert a new product into the products table
        $sql = "INSERT INTO wishlist_items (wishlist_id, product_id) 
                VALUES ('$wishlist_id', '$        $sql = "INSERT INTO wishlist_items (wishlist_id, product_id) 
', '$product_price', '$stock_quantity', '$productImage')";
