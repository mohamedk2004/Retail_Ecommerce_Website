...
class Review extends Model
{
  ...
  function __construct($id, $review_id, $user_id = "", $rating = "", $product_price = "", $stock_quantity = "", $product_image = "")
  {
    $this->product_id = $id;
...
function editProduct($user_id, $rating, $product_price, $stock_quantity)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET user_id='$productName', rating='$rating', product_price='$product_price', stock_quantity='$stock_quantity' WHERE product_id=$this->product_id;";
