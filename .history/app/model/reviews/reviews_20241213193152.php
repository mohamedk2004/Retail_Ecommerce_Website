...
class Review extends Model
{
  ...
  function __construct($id, $review_id, $product_ = "", $product_description = "", $product_price = "", $stock_quantity = "", $product_image = "")
  {
    $this->product_id = $id;
...
public function setProduct_name($product_){
    $this->product_ = $productName;
}
...
function readProduct($id)
{
    ...
    if ($result->num_rows == 1) {
        ...
        $_SESSION["product_"] = $row["productName"];
    } else {
...
function editProduct($product_, $product_description, $product_price, $stock_quantity)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET product_='$productName', product_description='$product_description', product_price='$product_price', stock_quantity='$stock_quantity' WHERE product_id=$this->product_id;";
