...
class Review extends Model
{
  ...
  function __construct($id, $review_id, $product_nam = "", $product_description = "", $product_price = "", $stock_quantity = "", $product_image = "")
  {
    $this->product_id = $id;
...
public function getProduct_name(){
    return $this->product_nam;
}

public function setProduct_name($product_nam){
    $this->product_nam = $productName;
}
...
function readProduct($id)
{
    ...
    if ($result->num_rows == 1) {
        ...
        $this->product_nam = $row["product_nam"];
        ...
        $_SESSION["product_nam"] = $row["productName"];
    } else {
...
function editProduct($product_nam, $product_description, $product_price, $stock_quantity)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET product_nam='$productName', product_description='$product_description', product_price='$product_price', stock_quantity='$stock_quantity' WHERE product_id=$this->product_id;";
