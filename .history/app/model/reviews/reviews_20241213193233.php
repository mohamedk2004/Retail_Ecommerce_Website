...
class Review extends Model
{
  ...
  function __construct($id, $review_id, $user_id = "", $rating = "", $review = "", $created_at = "", $product_image = "")
  {
    $this->product_id = $id;
...
public function setStock_quantity($created_at){
    $this->created_at = $created_at;
}
...
function editProduct($user_id, $rating, $review, $created_at)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET user_id='$productName', rating='$rating', review='$review', created_at='$created_at' WHERE product_id=$this->product_id;";
