...
class Products extends Model
{
  ...
  function __construct($id, $category_id, $product_name = "", $product_description = "", $product_price = "", $stockQuantity = "", $productImage = "")
  {
    $this->produc_id = $id;
...
function editProduct($product_name, $product_description, $product_price, $stockQuantity)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET product_name='$productName', product_description='$product_description', product_price='$product_price', stockQuantity='$stockQuantity' WHERE produc_id=$this->produc_id;";
