...
class Product {
    ...
    function __construct($productId, $productName, $productDescription, $productPrice, $stockQuantity, $createdAt, $productImage) {
    ...
    // Add getter methods for each property if needed
}