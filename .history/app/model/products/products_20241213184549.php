...
class Products extends Model
{
  ...
  function __construct($id, $category_id, $product_name = "", $productDescription = "", $productPrice = "", $stockQuantity = "", $productImage = "")
  {
    $this->produc_id = $id;
...
function editProduct($product_name, $productDescription, $productPrice, $stockQuantity)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET product_name='$productName', productDescription='$productDescription', productPrice='$productPrice', stockQuantity='$stockQuantity' WHERE produc_id=$this->produc_id;";
