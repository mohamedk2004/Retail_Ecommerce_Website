...
class PaymentsModel extends Model {
    ...
    function addProduct($productName, $productDescription, $productPrice, $stockQuantity, $productImage) {
        ...
        $sql = "INSERT INTO payments (amount, product_description, product_price, stock_quantity, product_image) 
                VALUES ('$amount', '$product_description', '$product_price', '$stock_quantity', '$product_image')";
