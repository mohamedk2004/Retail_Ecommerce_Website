...
function editPayment($amount, $payment_method, $payment_date, $stock_quantity)
{
    // Prepare the SQL query to update payment details
    $sql = "UPDATE payment SET amount='$productName', payment_method='$payment_method', payment_date='$payment_date', stock_quantity='$stock_quantity' WHERE payment_id=$this->payment_id;";

    // Execute the query and check if it's successful
    if ($this->db->query($sql) === true) {
        echo "Product updated successfully.";
        // Optionally, re-read the payment data after updating
...
function deleteProduct()
{
    ...
    $sql = "DELETE FROM payment WHERE payment_id=$this->payment_id;";
