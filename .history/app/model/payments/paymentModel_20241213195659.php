...
class PaymentsModel extends Model {
    ...
    function addProduct($productName, $productDescription, $productPrice, $stockQuantity, $productImage) {
        ...
        $sql = "INSERT INTO payments (amount, payment_method, product_price, stock_quantity, product_image) 
                VALUES ('$amount', '$payment_method', '$product_price', '$stock_quantity', '$product_image')";
