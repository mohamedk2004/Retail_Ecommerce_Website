...
class Payment extends Model
{
  ...
  function __construct($id, $order_id, $amount = "", $product_description = "", $product_price = "", $stock_quantity = "", $product_image = "")
  {
    $this->payment_id = $id;
...
function editProduct($amount, $product_description, $product_price, $stock_quantity)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET amount='$productName', product_description='$product_description', product_price='$product_price', stock_quantity='$stock_quantity' WHERE payment_id=$this->payment_id;";
