...
class CategoryModel extends Model {
    ...
    function addCategory($category_name, $category_description, $productPrice, $stockQuantity, $productImage) {
        // SQL query to insert a new product into the categories table
        $sql = "INSERT INTO categories (category_name, category_description, product_price, stock_quantity, product_image) 
                VALUES ('$category_name', '$category_description', '$product_price', '$stock_quantity', '$product_image')";
