...
class Category extends Model
{
  ...
  function __construct($id, $category_id, $category_name = "", $product_description = "", $product_price = "", $stock_quantity = "", $product_image = "")
  {
    $this->category_id = $id;
...
function editProduct($category_name, $product_description, $product_price, $stock_quantity)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET category_name='$productName', product_description='$product_description', product_price='$product_price', stock_quantity='$stock_quantity' WHERE category_id=$this->category_id;";
