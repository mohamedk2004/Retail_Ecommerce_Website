...
function editCategory($category_name, $category_description, , $stock_quantity)
{
    // Prepare the SQL query to update product details
    $sql = "UPDATE products SET category_name='$productName', category_description='$category_description',='', stock_quantity='$stock_quantity' WHERE category_id=$this->category_id;";
