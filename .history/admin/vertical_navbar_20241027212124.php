...
<head>
    ...
    <link rel="stylesheet" href="path/to/your/styles.css"> <!-- Link to your external CSS -->
</head>

<body>
    <nav class="navbar navbar-light flex-column admin-navbar">
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="order_management.php">Order Management</a></li>
