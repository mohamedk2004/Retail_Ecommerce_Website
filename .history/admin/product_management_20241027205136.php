...
<body>
    <div class="d-flex">
        ...
        <div class="sidebar-wrapper">
            ...
            <button class="navbar-toggler d-md-none bg-primary text-white" type="button" data-bs-toggle="collapse"
            ...
            <!-- Sidebar Content -->
            <div class="sidebar collapse d-md-block bg-light p-3" id="sidebarMenu">
                <h3 class="text-primary">AMSol</h3>
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-3">
                        <a class="nav-link" href="#"><i class="bi bi-shop"></i> Store Management</a>
                    </li>
                    <li class="nav-item mb-3">
                        <a class="nav-link" href="#"><i class="bi bi-tag-fill"></i> Price Management</a>
                    </li>
                    <li class="nav-item mb-3">
                        <a class="nav-link" href="#"><i class="bi bi-truck"></i> Vendor Management</a>
                    </li>
                    <li class="nav-item mb-3">
                        <a class="nav-link" href="#"><i class="bi bi-boxes"></i> Inventory Management</a>
                    </li>
                    <li class="nav-item mb-3">
                        <a class="nav-link" href="#"><i class="bi bi-shop-window"></i> POS</a>
                    </li>
