...
class User
{
    ...
    static function signUp($fn, $ln, $em, $pss)
    {
        $crAt = date('Y-m-d H:i:s');
        $role = str_starts_with($em, 'admin') ? 'admin' : 'customer';

        $sql = "INSERT into users (firstname, lastname, email, password, created_at, role) values ('$fn','$ln', '$em', '$pss', '$crAt', '$role')";
    ...
    static function updatePassword($email, $newPassword, $comfirmedPassword)
    {
